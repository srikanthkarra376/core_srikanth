...
public class TestHibernateDAO {
	...
	public void testEndToEndCrud(){
		Identity identity = new Identity("123", "srikanth", "sri@sri.com");
		dao.write(identity);
		
		Assert.assertTrue(identity.getId()!= 0);
		identity.setDisplayName("Sri");
		dao.update(identity);
		
		Identity criteria = new Identity(null, "Sri", null);
	...
	public void testWhereClauseBuilder() throws IllegalArgumentException, IllegalAccessException{
		...
		Identity identity = new Identity("123", "srikanth karra", "tbr@tbr.com");
		dao.write(identity);
